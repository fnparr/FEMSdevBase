...
setMethod (f = "generateEvents",
           ...
           definition = function(host){
             ...
             simulationRsp <- simulationRequest(ptf = host$portfolio,
                                                url = host$actusServerURL,
                                                rfs = host$scenario)
...
setMethod (f = "generateEvents",
           signature = c(host = "ContractAnalysis", ptf="missing",
                         ...
                         monitoringTimes = "missing"),
           definition = function(host, scenarioID){
             # sends input portfolio contracts and riskFactors to server as JSON
             simulationRsp <- simulationRequest(ptf = host$portfolio,
                                                url = host$actusServerURL,
...
setMethod (f = "generateEvents",
           ...
           definition = function(host, scenarioID, simulateToDate, monitoringTimes){
             # sends input portfolio contracts and riskFactors to server as JSON
             simulationRsp <- simulationRequest(ptf = host$portfolio,
                                                url = host$actusServerURL,
                                                scenarioID = scenarioID,
