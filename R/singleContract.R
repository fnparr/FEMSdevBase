...
#' @return    initialized Annuity contract contract with specified attributes.
#' @usage {
#'           mortgage(start, maturity, nominal, coupon, paymentFreq, role,
#'                   rateResetFreq, rateResetSpread )
#'        }
#' @examples {
...
#' @param nominal    numeric to set the notional principal of the bond,
#' @param coupon    numeric coupon/interest rate 0.02 = 2pc pa default 0.0 .
...
#' @usage  {
#'            bondvr(start, maturity, nominal, coupon, paymentFreq, role,
#'                   rateResetFreq, rateResetSpread )
#'         }
#' @examples {
