...
#' Timeline()
#' Generic function to create a Timeline object
...
#' Timeline()
#' Constructs an empty Timeline object with no fields initialized.
#' This is the default constructor.
#' @return Timeline S4 object - empty, no fields initialized
...
#' @param periodCount integer number of periods including valuation periods
#'
#' @return Timeline S4 object - initialized, ready to use in CashflowAnalysis()
#' @export
#' @import lubridate
#' @examples {
