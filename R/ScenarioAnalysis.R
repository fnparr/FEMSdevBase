...
setMethod (f = "generateEvents",
           ...
           definition = function(host, ptf, serverURL){
             ...
             simulationRsp <- simulationRequest(ptf = ptf, url = serverURL, rfs = host$marketData)
...
setMethod (f = "generateEvents",
           signature = c(host = "ScenarioAnalysis", ptf="Portfolio",
                         ...
                         monitoringTimes = "missing"),
           definition = function(host, ptf, serverURL, scenarioID){
             # sends input portfolio contracts and riskFactors to server as JSON
...
setMethod (f = "generateEvents",
           ...
           definition = function(host, ptf, serverURL, scenarioID, simulateToDate, monitoringTimes){
             # sends input portfolio contracts and riskFactors to server as JSON
